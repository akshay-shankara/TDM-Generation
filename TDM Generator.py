...
while i < path_length:
    with open(file_directory + str(i) + ".txt", "r") as f:
        ...
        file_directory2 = ('/Users/akshay/Desktop/output_files Frequency Table/fileFreq%d.txt' % i)
        input_file = open(file_directory2, 'w')

        intermediate_dir = ('/Users/akshay/Desktop/Intermediate/intFreq%d.txt' % i)
...
file_directory2 = '/Users/akshay/Desktop/output/output.txt'
input_file = open(file_directory2, 'w')
